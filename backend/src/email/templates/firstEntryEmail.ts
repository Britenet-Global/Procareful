          ...
          <td>
            <table align="center" width="100%" border="0" cellPadding="0" cellSpacing="0" role="presentation" style="width:504px">
              <tbody>
                <tr>
                  <td>
                    <h1 style="text-align:center;font-size:24px">${activateYourAccount}</h1>
                    <p style="font-size:16px;line-height:24px;margin:16px 0;margin-top:32px;color:#1F2933;text-align:left">${welcome}:</p>
            ...
            </table><a href=${domain}/signup/${token} style="line-height:24px;text-decoration:none;display:block;max-width:100%;background-color:#079A82;border-radius:2px;color:#fff;font-size:16px;text-align:center;width:86%;margin:0 auto;margin-top:48px;padding:8px 8px 8px 8px" target="_blank"><span><!--[if mso]><i style="letter-spacing: 8px;mso-font-width:-100%;mso-text-raise:12" hidden>&nbsp;</i><![endif]--></span><span style="max-width:100%;display:inline-block;line-height:120%;mso-padding-alt:0px;mso-text-raise:6px">${activate}</span><span><!--[if mso]><i style="letter-spacing: 8px;mso-font-width:-100%" hidden>&nbsp;</i><![endif]--></span></a>
            <p style="font-size:16px;line-height:24px;margin:16px 0;color:#1F2933;text-align:left;margin-top:48px;margin-bottom:4px">${orClickLink}:</p><a href=${domain}/signup/${token} style="color:#079A82;text-decoration:none;margin-right:50px" target="_blank">${domain}/signup/${token}</a>
          </td>
        </tr>
      </tbody>
    </table>

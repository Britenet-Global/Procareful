          ...
          <td>
            <table align="center" width="100%" border="0" cellPadding="0" cellSpacing="0" role="presentation" style="width:504px">
              <tbody>
                <tr>
                  <td>
                    <h1 style="text-align:center;font-size:24px">${downloadOurApp}</h1>
                    <p style="font-size:16px;line-height:24px;margin:16px 0;margin-top:32px;color:#1F2933;text-align:left">${thankYou}:</p>
